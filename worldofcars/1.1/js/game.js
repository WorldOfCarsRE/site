...
jQuery( document ).ready( function() {
	...
	function embedFlash( bannerMsg ) {
		...
		swfobject.embedSWF( PATH.cdnRoot +'/game/DVC_OS.swf?ver='+ clientVersion, 'pla-gameModule', '100%', '100%', '10.0.0', false, jQuery.extend( {}, GAME.flashVars, qsVars, { 'customMsg' : escape( ( bannerMsg || closingMessage ) ) } ), GAME.params );
	};
